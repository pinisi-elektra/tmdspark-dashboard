<?php namespace App\Http\Controllers;
    ...
    class AdminOwnersController extends \crocodicstudio\crudbooster\controllers\CBController
    {
        public function cbInit()
        {
            ...
            $this->col[] = ["label"=>"Nama","name"=>"name", "callback_php" => '$row->name ?? "-"'];
            $this->col[] = ["label"=>"Email","name"=>"email", "callback_php" => '$row->email ?? "-"'];
            $this->col[] = ["label"=>"No. HP","name"=>"phone", "callback_php" => '$row->phone ?? "-"'];
            $this->col[] = ["label"=>"Parkiran","name"=>"parking_id", "join" => "lots,name", "callback_php" => '$row->lots_name ?? "-"'];
            ...
            $this->form[] = ['label'=>'Parkiran','name'=>'parking_id','type'=>'select2','validation'=>'required|integer|exists:lots,id', "datatable" => "lots,name", "datatable_where" => "status = 'Active'", "datatable_format" => 'name," - ",address'];
