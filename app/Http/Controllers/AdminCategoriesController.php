<?php namespace App\Http\Controllers;
    ...
    class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController
    {
        public function cbInit()
        {
            ...
            $this->form = [];
            // $this->form[] = ['label'=>'Icon','name'=>'icon','type'=>'upload','validation'=> 'nullable|image|mimes:png|max:5000','width'=>'col-sm-10', "help" => "Hanya menerima file PNG dengan ukuran maksimal 5Mb", "encrypt" => true];
            $this->form[] = ['label'=>'Nama','name'=>'name','type'=>'text','validation'=>'required|regex:/^[0-9a-zA-Z\s]*$/|min:3|max:50','width'=>'col-sm-10','placeholder'=>'Anda hanya dapat memasukkan huruf saja'];
