...
class AdminCmsUsersController extends CBController
{
    public function cbInit()
    {
        ...
        $this->form = [];
        $this->form[] = ["label"=>"Nama","name"=>"name", "type" => "text", 'validation'=>'required|string|min:3|max:50|unique:cms_users,name', "disabled" => Cx::isSuperAdmin() ? false : true, "exception" => Cx::isSuperAdmin() ? false : true];
