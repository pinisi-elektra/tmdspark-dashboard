    ...
    class AdminClosedTransactionsController extends \crocodicstudio\crudbooster\controllers\CBController
    {
        public function cbInit()
        {
            ...
            $this->col[] = ["label"=>"Foto Keluar","name"=>"photo_check_out", "callback" => function($q){
                ...
                return '<a data-lightbox="roadtrip" rel="group_{closed_transactions}" title="Foto Keluar: 21072710562101" href="' . $img . '"><img width="40px" height="40px" src="' . $img . '"></a>';
            }];
            ...
            $this->col[] = ["label"=>"Lama Parkir","name"=>"elapsed_time", "callback_php" => 'number_format($row->elapsed_time) . " Jam"'];
            ...
            $this->col[] = ["label"=>"Metode Pembayaran","name"=>"payment_method", "filter" => 1];
            $this->col[] = ["label"=>"Total","name"=>"total", "callback_php" => '"Rp". number_format($row->total)', "filter" => 1];
            ...
            $this->col[] = ["label"=>"Petugas Keluar","name"=>"close_staff_id","join"=>"cms_users,name"];
