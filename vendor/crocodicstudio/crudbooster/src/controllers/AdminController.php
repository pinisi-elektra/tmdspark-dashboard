...
class AdminController extends CBController
{
    ...
    public function postLogin()
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('getLogin')->withInput()->with('toast_warning', implode(', ', $message));
        }
        ...
        if ($users && \Hash::check($password, $users->password)) {
            ...
            return redirect(CRUDBooster::adminPath())->with('toast_success', "Selamat datang, $users->name!");
        } else {
            return redirect()->route('getLogin')->withInput()->with('toast_warning', cbLang('alert_password_wrong'));
        }
    }
