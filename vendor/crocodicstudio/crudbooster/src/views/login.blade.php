    ...
    <div class="container">
        <div class="login-box">
            ...
            <div class="login-box-body animated slideInUp">
                ...
                <h4 class="login-box-msg m-0">Easy Parking Management</h4>

                <form autocomplete="off" action="{{ route("postLogin") }}" method="post">
                    @csrf

                    <div class="form-group has-feedback">
                        <input autocomplete="off" type="text" class="form-control" name="email" required placeholder="Email" value="{{ old('email') }}"/>
