...
<div class='form-group {{$header_group_class}}' id='form-group-{{$name}}'>
    ...
    @if($form['columns'])
        <div class="col-sm-12">
            ...
            <div id='panel-form-{{$name}}' class="box box-primary">
                    ...
                    <div class='row'>
                        <div class='col-sm-10'>
                            <div class="box box-primary">
                                <div class="box-header"><i class="fa fa-pencil-square-o"></i> {{cbLang("text_form")}}</div>
                                <div class="box-body child-form-area">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addToTable{{$name}}() {
                                                ...
                                                @endif
                                                        @endforeach
                                                    trRow += "<td>" +
                                                    "<a href='#panel-form-{{$name}}' onclick='editRow{{$name}}(this)' class='btn btn-warning btn-xs'><i class='fa fa-pencil-alt'></i></a> " +
