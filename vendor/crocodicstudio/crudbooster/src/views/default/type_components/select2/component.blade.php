            ...
            @if($form['datatable'])
                @if($form['relationship_table'])
                    ...
                    if(!isset($form['datatable_append'])) {
                     $result = $result->select($pk, $select_title);
                    }
                    if ($select_where) {
                    ...
                    if($form['datatable_orig'] != ''){
                        ...
                        $value = DB::table($params[0])->where($params[2], $id)->first();
                    ...
                    foreach ($result as $r) {
                        if(isset($form['datatable_append'])) {
                            ...
                            $dt_append = DB::table($datatable_append[0])->where('id', $r->{$datatable_append[1]})->first()->{$datatable_append[2]};
                            $option_label = $r->{$select_title} . ' (' . $dt_append . ')';
                        }
                        else {
