...
<div class="lockscreen-wrapper">
    ...
    <!-- User name -->
    <div class="lockscreen-name">{{CRUDBooster::getSetting('admin_name')}}</div>

    <!-- START LOCK SCREEN ITEM -->
    <div class="lockscreen-item">
        <!-- lockscreen image -->
        <div class="lockscreen-image">
            <img src="{{ (CRUDBooster::getSetting('admin_photo'))?:asset("assets/adminlte/dist/img/user2-160x160.jpg") }}" alt="user image"/>
        </div>
        <!-- /.lockscreen-image -->
